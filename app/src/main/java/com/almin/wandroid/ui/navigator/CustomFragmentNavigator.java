...
public class CustomFragmentNavigator extends Navigator<CustomFragmentNavigator.Destination> {
    ...
    @Nullable
    @Override
    public NavDestination navigate(@NonNull CustomFragmentNavigator.Destination destination, @Nullable Bundle args,
...
//        frag.setArguments(args);
        ...
        // show type
        String type = AppNavigator.NAVIGATION_TYPE_ADD;
        if(args != null){
            type = args.getString(AppNavigator.TYPE_KEY, AppNavigator.NAVIGATION_TYPE_ADD);
        }
        switch (type){
            case AppNavigator.NAVIGATION_TYPE_ADD:
                ft.add(mContainerId, frag, tag);
                break;
            case AppNavigator.NAVIGATION_TYPE_REPLACE:
...
//        ft.replace(mContainerId, frag);
    ...
    public static class Destination extends NavDestination {
         ...
         */
        public Destination(@NonNull Navigator<? extends CustomFragmentNavigator.Destination> fragmentNavigator) {
         ...
         */
        @NonNull
        public final CustomFragmentNavigator.Destination setClassName(@NonNull String className) {
    ...
    public static final class Extras implements Navigator.Extras {
        ...
        public static final class Builder {
             ...
             */
            @NonNull
            public CustomFragmentNavigator.Extras.Builder addSharedElements(@NonNull Map<View, String> sharedElements) {
             ...
             */
            @NonNull
            public CustomFragmentNavigator.Extras.Builder addSharedElement(@NonNull View sharedElement, @NonNull String name) {
             ...
             */
            @NonNull
            public CustomFragmentNavigator.Extras build() {
                return new CustomFragmentNavigator.Extras(mSharedElements);
            }
        }
    }
}
