...
public class StatusBarUtil {
    ...
    public static void setAppbarTopPadding(ViewGroup rootView, int appbarId){
        AppBarLayout appBarLayout = rootView.findViewById(appbarId);
        appBarLayout.setPadding(0, getStatusBarHeight(rootView.getContext()),0,0);
    }

    public static void setAppbarTopPadding(AppBarLayout appBarLayout){
        appBarLayout.setPadding(0, getStatusBarHeight(appBarLayout.getContext()),0,0);
    }
